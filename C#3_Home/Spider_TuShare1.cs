...
{
	class Spider_TuShare1
	{

	}

	public interface IHttpClientUtility1
	{
		string HttpClientPost1(string url, object datajson);
	}

	public class HttpClientUtility1 : IHttpClientUtility1
	{

		public string HttpClientPost1(string url, object datajson)
		{
	...
	// ————————————————————————————————————
	public class JsonContent1 : StringContent
	{
		public JsonContent1(object value)
			: base(JsonConvert.SerializeObject(value), Encoding.UTF8, "application/json")
		{
		}

		public JsonContent1(object value, string mediaType)
	...
	public class TuShareUtility1
	{
		private IHttpClientUtility1 _httpClientUtility1;
		private string _url = "http://api.waditu.com/";

		public TuShareUtility1(IHttpClientUtility1 httpClientUtility)
		{
			_httpClientUtility1 = httpClientUtility;
		}

		public DataTable GetData1(string apiName, Dictionary<string, string> parmaMap, params string[] fields)
		{
			var tuShareParamObj = new TuShareParamObj() { ApiName = apiName, Params = parmaMap, Fields = string.Join(",", fields) };
			Console.WriteLine(JsonConvert.SerializeObject(tuShareParamObj, Formatting.Indented));
			//做Http调用
			var result = _httpClientUtility1.HttpClientPost1(_url, tuShareParamObj);
			//将返回结果序列化成对象
